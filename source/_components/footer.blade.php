<footer class="mt-6 md:mt-12 bg-gray-200">
    <div class="max-w-4xl mx-auto px-6 py-6 md:py-12">
        <div class="flex-auto w-full max-w-4xl mx-auto">
            <div class="sm:flex">
                <img src="/assets/images/nihir-zala.jpg"
                    alt="Photo of Nihir Zala"
                    class="
                ...
                <div class="mt-4 sm:mt-0 sm:flex-grow">
                    <div class="markdown max-w-2xl text-base">
                        <p>Hi there, I'm Nihir Zala&mdash;a full-stack web application developer from <span class="whitespace-no-wrap"> India</span>, with over 1.5 years professional experience. You can learn more about me on my <a href="/">home page</a>.</p>
                    ...
                    <p class="mt-8">
                        ...
                        <a
                            ...
                            target="_blank"
                            class="ml-3 inline-block text-gray-500 border-0 hover:text-gray-700 focus:text-gray-700"
                        >
                    ...
                    {{-- <svg role="img" aria-label="LGBTI Pride flag" class="mt-4 h-3" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 777 480">
