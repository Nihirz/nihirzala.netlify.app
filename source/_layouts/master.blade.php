...
<html lang="en">
    <head>
        ...
        <meta property="og:image" content="{{ $page->baseUrl }}/assets/images/{{ $page->image ?: 'nihir-zala.jpg' }}" />
        ...
        @if ($page->image)
            ...
            <meta name="twitter:image" content="{{ $page->baseUrl }}/assets/images/{{ $page->image ?: 'nihir-zala.jpg' }}" />
        @endif
        ...
        @if ($page->production)
            <script src="https://smile-calm.jessarcher.com/script.js" data-site="JGZVJFVC" defer></script><!DOCTYPE html>
            <html lang="en">
                <head>
                    <meta charset="utf-8">
                    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
